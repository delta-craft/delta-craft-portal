...
import { PlayerStats_player_stats_crafting } from "../../../src/gql/client/types/PlayerStats";
...
interface IProps {
  stats: PlayerStats_player_stats_crafting;
}

const CraftingSummary: React.FC<IProps> = ({ stats }) => {
          ...
          <div className="col-6 col-md-2 p-2" key={index}>
            <Tooltip title={item.material}>
              <Paper className="d-flex py-1 justify-content-center align-items-center summary-card">
                ...
                >
                  <Image
                    src={`/img/points/crafting/${item.material}.webp`}
                    layout="fill"
                    alt=""
                  />
                </div>
...
export default CraftingSummary;
